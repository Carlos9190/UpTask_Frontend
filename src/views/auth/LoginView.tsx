...
export default function LoginView() {
    ...
    return (
        <div className="flex flex-col flex-grow justify-center items-center w-full h-full px-4 sm:px-8 lg:px-0">
            ...
            <form
                ...
                className="w-full max-w-xs sm:max-w-sm md:max-w-md bg-white shadow-lg rounded-xl p-6 sm:p-8 mt-6"
                noValidate
            >
                ...
                <input
                    ...
                    className="bg-fuchsia-600 hover:bg-fuchsia-700 w-full p-3 text-white font-black text-lg cursor-pointer rounded-lg mt-4"
                />
            </form>

            <nav className="mt-6 flex flex-col space-y-2 w-full max-w-xs sm:max-w-sm">
